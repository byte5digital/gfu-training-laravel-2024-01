...
<div {{ $attributes->merge(['role' => 'alert', 'class' => 'bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded relative']) }}>

    <strong class="font-bold">{{ $headline ?? 'Error'}}</strong>
